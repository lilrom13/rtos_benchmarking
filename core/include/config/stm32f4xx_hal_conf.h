...
#define HAL_GPIO_MODULE_ENABLED 0
#define HAL_EXTI_MODULE_ENABLED 0
...
#define HAL_PWR_MODULE_ENABLED 0
#define HAL_QSPI_MODULE_ENABLED 0
#define HAL_RCC_MODULE_ENABLED 0
...
#define HAL_SPI_MODULE_ENABLED 0
#define HAL_TIM_MODULE_ENABLED 0
#define HAL_UART_MODULE_ENABLED 0
#define HAL_USART_MODULE_ENABLED 0
#define HAL_IRDA_MODULE_ENABLED 0
#define HAL_SMARTCARD_MODULE_ENABLED 0
#define HAL_WWDG_MODULE_ENABLED 0
#define HAL_CORTEX_MODULE_ENABLED 0
#define HAL_PCD_MODULE_ENABLED 0
#define HAL_HCD_MODULE_ENABLED 0
#define HAL_FMPI2C_MODULE_ENABLED 0
#define HAL_FMPSMBUS_MODULE_ENABLED 0
#define HAL_SPDIFRX_MODULE_ENABLED 0
#define HAL_DFSDM_MODULE_ENABLED 0
#define HAL_LPTIM_MODULE_ENABLED 0
